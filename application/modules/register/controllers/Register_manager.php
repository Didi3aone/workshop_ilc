...
class Register_manager extends MX_Controller {
    ...
    private $_js_view     = "register/javascript/";
    private $_header;
    private $_footer;
    private $_data;
    ...
    */
    ...
    {
    	$regis = $this->_dm->set_model($this->_table,$this->_table_alias,$this->_pk_field)->get_all_data(
			array(
				"select"     => $this->_table_alias.".*, tpl.PelatihanTitle, tpl.PelatihanStartDate,
								tpj.*,tpb.*",
				"joined"     => array(
					"tbl_pelatihan tpl" => array("tpl.PelatihanId" => $this->_table_alias.".pendaftaran_training_id"),
					"tbl_penanggung_jawab tpj" => array("tpj.pendaftaran_id" => $this->_table_alias.".pendaftaran_id"),
					"tbl_penanggung_bayar tpb" => array("tpb.pendaftaran_id" => $this->_table_alias.".pendaftaran_id") 
				),
				"row_array"  => true,
				"conditions" => array($this->_table_alias.".".$this->_pk_field => $regis_id)
			))['datas'];

		$this->_data['regis'] = $regis;

       	$this->_header = array( 
            "title"      => $this->_title,   
            "title_page" => $this->_title_page,
            "breadcrumb" => $this->_breadcrumb ."<li>Detail User Register</li>",
            "active_page"=> $this->_active_page
        );
