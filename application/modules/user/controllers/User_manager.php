...
class User_manager extends CI_Controller {
    ...
    public function index() {
        ...
        $footer = array(
            ...
            'script_js' => $this->_view_js_folder . "list_js",
        );
    ...
    public function edit ($user_id = null) {
        ...
        $params = array(
            ...
            "joined" => array("tbl_user_role tur" => array("tur.role_Id" => "tu.role_Id"))
        );
        //get the data.
    ...
    public function process_form() {
        ...
        if ($this->form_validation->run($this) == FALSE) {
            ...
            //insert or update?
            if ($id == "") {
                $arrayToDB['password']	   = sha1($password);
                $arrayToDB['created_date'] = NOW;
                $arrayToDB['created_by']   = $createdby;
                // pr($this->input->post());exit;
                //insert to DB.
                ...
                if ($this->db->trans_status() === FALSE) {
                    ...
                    $message['redirect_to'] = site_url("manaager/user");
                }

            } else {
                //update.
                if ($new_password != "") {
                    $arrayToDB['password'] = sha1($new_password);
                }
...
/* Location: ./application/modules/user/controllers/User_manager.php */