<?php
    ...
    $role_id          = isset($item["role_Id"]) ? $item["role_Id"] : "";
    $role_name        = isset($item["role_name"]) ? $item["role_name"] : "";
                    ...
                    <div>
                        ...
                        <form class="smart-form" id="form" action="<?= site_url(); ?>manager/user/process_form" method="post">
                            ...
                            <footer>
                                ...
                                <a href="<?= site_url() ?>manager/user" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Cancel</a>
                            </footer>
                        </form>
                    </div>
                    <!-- end widget content -->
