<script>
    var lists = function () {
        ...
        var ajax_source = "<?= site_url('manager/contact/list_all_data'); ?>";
        var url = "<?= site_url('manager/contact/'); ?>";
            ...
            {"data": "subject"},
            {
                ...
                "render": function(data, type, full) {
                    ...
                    var edit =  '<td>';
                        ...
                        edit +=  ' <a href="' + url + 'detail/'+full.id +'" class="btn btn-info btn-circle" rel="tooltip" title="Lihat Detail" data-placement="top" ><i class="fa fa-eye"></i></a>&nbsp;';
