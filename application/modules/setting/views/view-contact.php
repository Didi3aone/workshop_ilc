                        ...
                        <form id="form" class="smart-form" method="POST" action="<?= site_url('manager/setting/process_form_contact') ?>">
                            ...
                            <fieldset>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        <input type="text" name="hp" readonly value="<?= $hp; ?>" placeholder="Hp">
                                    </label>
                                </section>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        <input type="text" name="telp" readonly value="<?= $telp; ?>" placeholder="No Telephone">
                                    </label>
                                </section>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        <input type="text" name="email" readonly value="<?= $email; ?>" placeholder="Email">
                                    </label>
                                </section>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        <input type="text" name="link" readonly value="<?= $link; ?>" placeholder="Link Maps">
                                    </label>
                                </section>
