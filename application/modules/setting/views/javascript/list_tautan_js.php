<script>
    var lists = function () {
        ...
        var ajax_source = "<?= site_url('manager/setting/list_all_data_tautan'); ?>";
            ...
            {"data": "tautan_link" },
            {
                ...
                "render": function(data, type, full) {
                    var edit =  '<td>';
                        ...
                        edit += '<a href="'+ url +'delete" data-id ="' + full.payment_id + '" data-name ="' + full.payment_bank + '" class="btn btn-danger btn-circle delete-confirm" rel="tooltip" title="Delete Payment" data-placement="top" ><i class="fa fa-trash-o"></i></a>';
