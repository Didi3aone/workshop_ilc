...
$root = str_replace("/assets/js/plugins//", "", $_SERVER['SCRIPT_NAME']);
$root = str_replace("/assets/js/plugins/filemanager/dialog.php", "", $root);
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']."/".$root."/assets",
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../../upload/files/thumbs/',
